...
[![版本](https://img.shields.io/badge/版本-0.1.37-blue)](https://github.com/43-COLLEGE-TEAM/Cloak/releases/tag/v0.1.37)
...
> 当前版本：**0.1.37**
>
> 发布页：[43-COLLEGE-TEAM/Cloak](https://github.com/43-COLLEGE-TEAM/Cloak/releases/tag/v0.1.37)

| 系统 | 下载 |
|------|------|
| Windows | [下载安装包](https://github.com/43-COLLEGE-TEAM/Cloak/releases/download/v0.1.37/Cloak_0.1.37_x64-setup.exe) |
| macOS（M 系列芯片）| [下载安装包](https://github.com/43-COLLEGE-TEAM/Cloak/releases/download/v0.1.37/Cloak_0.1.37_aarch64.dmg) |
| macOS（Intel 芯片）| [下载安装包](https://github.com/43-COLLEGE-TEAM/Cloak/releases/download/v0.1.37/Cloak_0.1.37_x64.dmg) |
| Linux 通用版 | [下载 AppImage](https://github.com/43-COLLEGE-TEAM/Cloak/releases/download/v0.1.37/Cloak_0.1.37_amd64.AppImage) |
...
- 🤖 **模型选择与 Claude 登录**：根据任务需要选择模型和 Claude Code 努力程度；团队工作区可使用组织统一配置的模型，个人用户可以在**设置 → 模型与环境**里选择服务商、填写 API Key，或使用自定义 API 端点，也可以在配置详情中查看 Claude 登录状态并选择适合自己的登录方式。模型不可用时，Cloak 会提示重试或切换备用模型。
